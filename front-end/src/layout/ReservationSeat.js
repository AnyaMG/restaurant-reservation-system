...
import { listTables, readReservation, assignReservationToTable } from '../utils/api';
...
function ReservationSeat() {
    ...
    useEffect(() => {
        ...
        const loadReservation = async () => {
            const returnedReservation = await readReservation(parseInt(params.reservation_id));
    ...
    const validateCapacity = () => {
        const foundTable = tables.find(table => table.table_id === parseInt(selectedTable));
    ...
    return (
        <div>
            ...
            <div className="input-group mt-3 mb-3">
                ...
                <select className="custom-select" name="table_id" value={selectedTable} onChange={tableSelect}>
